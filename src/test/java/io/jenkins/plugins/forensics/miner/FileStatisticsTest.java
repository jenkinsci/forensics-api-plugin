...
class FileStatisticsTest {
    ...
    void shouldCreateFileStatistics() {
        FileStatistics statistics = new FileStatistics(FILE, DAY * 10);
        ...
        statistics.inspectCommit(DAY * 9, "one");
