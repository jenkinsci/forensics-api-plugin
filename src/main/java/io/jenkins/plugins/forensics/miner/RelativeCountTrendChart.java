...
/**
 * Builds the Java side model for a trend chart showing the number of modified files, commits, and authors in the
 * repository. The trend chart contains three series, one for each criterion.  The number of builds to consider is
