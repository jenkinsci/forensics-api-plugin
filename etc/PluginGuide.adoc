...
|<back:AliceBlue>   </back>| UI Plugins |
endlegend
...
build. I hope to find some students this year to replace this dumb algorithm with an incremental scanner.
...
<j:jelly xmlns:j="jelly:core"  xmlns:c="/charts" xmlns:bs="/bootstrap">
    ...
    [...]
    <bs:card title="${%Number of authors}" fontAwesomeIcon="fa-users">
